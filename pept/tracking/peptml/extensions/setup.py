...
# Package meta-data.
NAME = 'find_cutpoints_api'
DESCRIPTION = 'Find the cutpoint of the shortest distance between every pair of lines'
URL = 'https://github.com/anicusan'
EMAIL = 'a.l.nicusan@bham.ac.uk'
AUTHOR = 'Andrei Leonard Nicusan'
REQUIRES_PYTHON = '>=3.6.0'
VERSION = '0.1.0'

TO_COMPILE = 'find_cutpoints_api.pyx'
