...
Prerequisites
-------------
This package supports Python 3.6 and above. You can install it using the
batteries-included Anaconda_ or the bare-bones Python_ interpreter. You can
also check out our Python and `pept` tutorials_.
